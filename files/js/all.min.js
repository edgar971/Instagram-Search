...
$(document).ready(function(){var queryString,usercontainer=document.createElement("ul");$(usercontainer).addClass("users"),$(".results").append(usercontainer),$(".searchUser").keyup(function(){var searchKey=$(".searchUser").val();return $(usercontainer).html(""),searchKey.length>=1&&$(".loader").addClass("spin-play"),searchKey.length>=3&&(console.log(searchKey),queryString="https://api.instagram.com/v1/users/search?q="+searchKey+"&access_token=359438134.e80aed7.a2363c18a8ae4200b1770b3f942bffed",$.ajax({url:queryString,type:"GET",dataType:"jsonp",global:!0,success:function(respondDATA){console.log(respondDATA.data.length);Array();$.each(respondDATA.data,function(a,b){var user=document.createElement("li"),usrIMG=document.createElement("img");usrIMG.setAttribute("src",b.profile_picture),usrIMG.setAttribute("alt",b.full_name),$(user).html('<a href="#'+b.username+'"data-user-id="'+b.id+'" data-user-img="'+b.profile_picture+'">\n							<img src="../../files/css/images/loader.gif"  alt="loader">\n							<p><strong>Username: </strong>'+b.username+"</p>\n							<p><strong>Full Name: </strong>"+b.full_name+"</p>\n							<p><strong>User ID: </strong>"+b.id+"</p>\n							</a>"),console.log(b.profile_picture),$(usercontainer).append(user)})},error:function(){alert("Something bad happened")},complete:function(){console.log("This request is done"),$(".loader").removeClass("spin-play").addClass("spin-stop"),loaderFired=!1}})),!1})});